...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("hadronsg4_r105_mod_FTFP_BERT_PYTHIA8_input_EPOS_W_0202.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("hadronsg4_r105_mod_FTFP_BERT_PYTHIA8_input_EPOS_W_0202.root");
      }
