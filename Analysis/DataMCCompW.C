...
TH1F *DZ1 = new TH1F("DZ_PD05","Delta Z",100,-100,2200);
TH1F *DZ2 = new TH1F("DZ_PD04","Delta Z",100,-100,2200);
TH1F *DZ3 = new TH1F("DZ_hadrons_g4_pythia1ryin_r102","Delta Z",100,-100,2200);
TH1F *DZ4 = new TH1F("DZ_hadrons-r102","Delta Z",100,-100,2200);

TH1F *SegX1 = new TH1F("SX_PD05","Segment X",100,0,140000);
TH1F *SegX2 = new TH1F("SX_PD04","Segment X",100,0,140000);
TH1F *SegX3 = new TH1F("SX_hadrons_g4_pythia1ryin_r102","Segment X",100,0,140000);
TH1F *SegX4 = new TH1F("SX_hadrons-r102","Segment X",100,0,140000);

TH1F *SegY1 = new TH1F("SY_PD05","Segment Y",100,0,110000);
TH1F *SegY2 = new TH1F("SY_PD04","Segment Y",100,0,110000);
TH1F *SegY3 = new TH1F("SY_hadrons_g4_pythia1ryin_r102","Segment Y",100,0,110000);
TH1F *SegY4 = new TH1F("SY_hadrons-r102","Segment Y",100,0,110000);

TH1F *PNum1 = new TH1F("PN_PD05","Parent Number",5,0,5);
TH1F *PNum2 = new TH1F("PN_PD04","Parent Number",5,0,5);
TH1F *PNum3 = new TH1F("PN_hadrons_g4_pythia1ryin_r102","Parent Number",5,0,5);
TH1F *PNum4 = new TH1F("PN_hadrons-r102","Parent Number",5,0,5);
...
void DataMCCompW()
{
  ...
  Data2 = TFile::Open("PD01Full.root");
  ...
  */
  ...
  Data3 = TFile::Open("../PythiaProduction/Out.root");
  Data4 = TFile::Open("../hadrons-r102/Out.root");
  ...
  for (int i = 0; i < treeDataTrk3->GetEntriesFast(); i++)
  {
    ...
    TLeaf *w = treeDataTrk3->GetLeaf("flagw");
  ...
  for (int i = 0; i < treeDataTrk4->GetEntriesFast(); i++)
  {
    ...
    TLeaf *w = treeDataTrk4->GetLeaf("flagw");
  ...
  for (int i = 0; i < Data4VtxSize; i++)
  {
    ...
    TLeaf *w = treeDataVtx4->GetLeaf("flagw");
  ...
  SlpTXHist1->GetYaxis()->SetRangeUser(0, 350000);
  HistDraw(SlpTXHist1, SlpTXHist2, SlpTXHist3, SlpTXHist4);
  Canvas->Print( "DataMCCompW.pdf(", "pdf");

  SlpTYHist1->GetYaxis()->SetRangeUser(0, 350000);
  HistDraw(SlpTYHist1, SlpTYHist2, SlpTYHist3, SlpTYHist4);
  Canvas->Print( "DataMCCompW.pdf", "pdf");

  SlpT2Hist1->GetYaxis()->SetRangeUser(0, 280000);
  HistDraw(SlpT2Hist1, SlpT2Hist2, SlpT2Hist3, SlpT2Hist4);
  Canvas->Print( "DataMCCompW.pdf", "pdf");

  IPData1->GetYaxis()->SetRangeUser(0, 700000);
  HistDraw(IPData1, IPData2, IPData3, IPData4);
  Canvas->Print( "DataMCCompW.pdf", "pdf");

  Mult1->GetYaxis()->SetRangeUser(0, 20000);
