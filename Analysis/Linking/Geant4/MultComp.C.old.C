...
void MultComp()
{
    ...
    for (int j = 0; j < 3; j++)
    {
        Mult1 = new TH1F("Mlt","Multiplicity",35,5,40);
        Mult2 = new TH1F("Mlt","Multiplicity",35,5,40);
        
        sprintf(outName,"MultComp_%d.pdf", j);
...
void HistDraw(TH1F *hist1, TH1F *hist2)
{
  ...
  legend->AddEntry(hist1,"VertexOut","f");
