...
void OutRatio()
{
    ...
    for (int j = 0; j < 8; j++)
    {
        ...
        if (j < 7) { snprintf(dir, 128, "/Users/emin/Desktop/Workspace/DsTau_Analysis/EPOSSM_v2.1/Linked/RootOut_3Sigma_Old/pl%02d1_%02d0.root", j, j + 3); }
        else { snprintf(dir, 128, "/Users/emin/Desktop/Workspace/DsTau_Analysis/EPOSSM_v2.1/Linked/RootOut_3Sigma_Old/pl071_105.root"); }
