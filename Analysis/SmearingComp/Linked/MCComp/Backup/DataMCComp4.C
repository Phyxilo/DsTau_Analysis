...
void DataMCComp4()
{
  ...
  sprintf(outName,"DataMCComp4.pdf");
  ...
  for (int dirIndex = 0; dirIndex < 8; dirIndex++)
  {
    ...
    for (int i = 0; i < treeMCVtx1->GetEntriesFast(); i++)
    {
      ...
      //if(PN->GetValue() > 0 && w->GetValue() == 1 && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() - initZ > migCut && vz->GetValue() - lastZ < -migCut)
      if(PN->GetValue() > 0 && w->GetValue() == 1 && areaBool && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() > MC1Mean - (250-migCut) && vz->GetValue() < MC1Mean + (250-migCut))
      {
    ...
    for (int i = 0; i < treeMCVtx2->GetEntriesFast(); i++)
    {
      ...
      //if(PN->GetValue() > 0 && w->GetValue() == 1 && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() - initZ > migCut && vz->GetValue() - lastZ < -migCut)
      if(PN->GetValue() > 0 && w->GetValue() == 1 && areaBool && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() > MC2Mean - (250-migCut) && vz->GetValue() < MC2Mean + (250-migCut))
      {
    ...
    for (int i = 0; i < treeMCVtx3->GetEntriesFast(); i++)
    {
      ...
      //if(PN->GetValue() > 0 && w->GetValue() == 1 && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() - initZ > migCut && vz->GetValue() - lastZ < -migCut)
      if(PN->GetValue() > 0 && w->GetValue() == 1 && areaBool && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() > MC3Mean - (250-migCut) && vz->GetValue() < MC3Mean + (250-migCut))
      {
    ...
    for (int i = 0; i < treeMCVtx4->GetEntriesFast(); i++)
    {
      ...
      //if(PN->GetValue() > 0 && w->GetValue() == 1 && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() - initZ > migCut && vz->GetValue() - lastZ < -migCut)
      if(PN->GetValue() > 0 && w->GetValue() == 1 && areaBool && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() > MC4Mean - (250-migCut) && vz->GetValue() < MC4Mean + (250-migCut))
      {
    ...
    for (int i = 0; i < treeMCVtx5->GetEntriesFast(); i++)
    {
      ...
      //if(PN->GetValue() > 0 && w->GetValue() == 1 && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() - initZ > migCut && vz->GetValue() - lastZ < -migCut)
      if(PN->GetValue() > 0 && w->GetValue() == 1 && areaBool && ((intTypeActive && iType->GetValue() >= 1) || (!intTypeActive)) && vz->GetValue() > MC5Mean - (250-migCut) && vz->GetValue() < MC5Mean + (250-migCut))
      {
  ...
  */
  ...
  TH1F *copyT2HistMC1 = (TH1F*) SlpT2HistData->Clone();
  copyT2HistMC1->SetName("T2Hist");
  copyT2HistMC1->Divide(SlpT2HistMC1);
  TH1F *copyT2HistMC2 = (TH1F*) SlpT2HistData->Clone();
  copyT2HistMC2->SetName("T2Hist");
  copyT2HistMC2->Divide(SlpT2HistMC2);
  TH1F *copyT2HistMC3 = (TH1F*) SlpT2HistData->Clone();
  copyT2HistMC3->SetName("T2Hist");
  copyT2HistMC3->Divide(SlpT2HistMC3);
  TH1F *copyT2HistMC4 = (TH1F*) SlpT2HistData->Clone();
  copyT2HistMC4->SetName("T2Hist");
  copyT2HistMC4->Divide(SlpT2HistMC4);
  TH1F *copyT2HistMC5 = (TH1F*) SlpT2HistData->Clone();
  copyT2HistMC5->SetName("T2Hist");
  copyT2HistMC5->Divide(SlpT2HistMC5);

  TH1F *copyIPHistMC1 = (TH1F*) IPDataData->Clone();
  copyIPHistMC1->SetName("IPHist");
  copyIPHistMC1->Divide(IPDataMC1);
  TH1F *copyIPHistMC2 = (TH1F*) IPDataData->Clone();
  copyIPHistMC2->SetName("IPHist");
  copyIPHistMC2->Divide(IPDataMC2);
  TH1F *copyIPHistMC3 = (TH1F*) IPDataData->Clone();
  copyIPHistMC3->SetName("IPHist");
  copyIPHistMC3->Divide(IPDataMC3);
  TH1F *copyIPHistMC4 = (TH1F*) IPDataData->Clone();
  copyIPHistMC4->SetName("IPHist");
  copyIPHistMC4->Divide(IPDataMC4);
  TH1F *copyIPHistMC5 = (TH1F*) IPDataData->Clone();
  copyIPHistMC5->SetName("IPHist");
  copyIPHistMC5->Divide(IPDataMC5);

  TH1F *copyMultHistMC1 = (TH1F*) MultData->Clone();
  copyMultHistMC1->SetName("MultHist");
  copyMultHistMC1->Divide(MultMC1);
  TH1F *copyMultHistMC2 = (TH1F*) MultData->Clone();
  copyMultHistMC2->SetName("MultHist");
  copyMultHistMC2->Divide(MultMC2);
  TH1F *copyMultHistMC3 = (TH1F*) MultData->Clone();
  copyMultHistMC3->SetName("MultHist");
  copyMultHistMC3->Divide(MultMC3);
  TH1F *copyMultHistMC4 = (TH1F*) MultData->Clone();
  copyMultHistMC4->SetName("MultHist");
  copyMultHistMC4->Divide(MultMC4);
  TH1F *copyMultHistMC5 = (TH1F*) MultData->Clone();
  copyMultHistMC5->SetName("MultHist");
  copyMultHistMC5->Divide(MultMC5);

  //if(intTypeActive) {SlpT2HistData->GetYaxis()->SetRangeUser(0, 150000);}
  //else {SlpT2HistData->GetYaxis()->SetRangeUser(0, 220000);}

  //SlpT2HistData->GetYaxis()->SetRangeUser(0, 25000);
  ...
  copyT2HistMC2->SetYTitle("Data / MC");
  copyT2HistMC2->GetYaxis()->SetLabelSize(0.05);
  copyT2HistMC2->GetXaxis()->SetLabelSize(0.05);

  copyT2HistMC2->Draw("HIST E1"); copyT2HistMC2->SetLineWidth(2); copyT2HistMC2->SetLineColor(kGreen); copyT2HistMC2->GetYaxis()->SetRangeUser(0, 2);
  copyT2HistMC3->Draw("SAMES HIST E1"); copyT2HistMC3->SetLineWidth(2); copyT2HistMC3->SetLineColor(kBlue); copyT2HistMC3->GetYaxis()->SetRangeUser(0, 2); copyT2HistMC3->SetStats(0);
  copyT2HistMC4->Draw("SAMES HIST E1"); copyT2HistMC4->SetLineWidth(2); copyT2HistMC4->SetLineColor(kMagenta); copyT2HistMC4->GetYaxis()->SetRangeUser(0, 2);  copyT2HistMC4->SetStats(0);
  copyT2HistMC5->Draw("SAMES HIST E1"); copyT2HistMC5->SetLineWidth(2); copyT2HistMC5->SetLineColor(kOrange + 2); copyT2HistMC5->GetYaxis()->SetRangeUser(0, 2); copyT2HistMC5->SetStats(0);
  copyT2HistMC1->Draw("SAMES HIST E1"); copyT2HistMC1->SetLineWidth(2); copyT2HistMC1->SetLineColor(kRed); copyT2HistMC1->GetYaxis()->SetRangeUser(0, 2); copyT2HistMC1->SetStats(0);
  ...
  IPDataData->GetYaxis()->SetRangeUser(0, 450000);
  ...
  copyIPHistMC2->SetYTitle("Data / MC");
  copyIPHistMC2->GetYaxis()->SetLabelSize(0.05);
  copyIPHistMC2->GetXaxis()->SetLabelSize(0.05);

  copyIPHistMC2->Draw("HIST E1"); copyIPHistMC2->SetLineWidth(2); copyIPHistMC2->SetLineColor(kGreen); copyIPHistMC2->GetYaxis()->SetRangeUser(0, 2);
  copyIPHistMC3->Draw("SAME HIST E1"); copyIPHistMC3->SetLineWidth(2); copyIPHistMC3->SetLineColor(kBlue); copyIPHistMC3->GetYaxis()->SetRangeUser(0, 2); copyIPHistMC3->SetStats(0);
  copyIPHistMC4->Draw("SAME HIST E1"); copyIPHistMC4->SetLineWidth(2); copyIPHistMC4->SetLineColor(kMagenta); copyIPHistMC4->GetYaxis()->SetRangeUser(0, 2); copyIPHistMC4->SetStats(0);
  copyIPHistMC5->Draw("SAME HIST E1"); copyIPHistMC5->SetLineWidth(2); copyIPHistMC5->SetLineColor(kOrange + 2); copyIPHistMC5->GetYaxis()->SetRangeUser(0, 2); copyIPHistMC5->SetStats(0);
  copyIPHistMC1->Draw("SAME HIST E1"); copyIPHistMC1->SetLineWidth(2); copyIPHistMC1->SetLineColor(kRed); copyIPHistMC1->GetYaxis()->SetRangeUser(0, 2); copyIPHistMC1->SetStats(0);
  ...
  MultData->GetYaxis()->SetRangeUser(0, 6500);
  ...
  copyMultHistMC2->SetYTitle("Data / MC");
  copyMultHistMC2->GetYaxis()->SetLabelSize(0.05);
  copyMultHistMC2->GetXaxis()->SetLabelSize(0.05);

  copyMultHistMC2->Draw("HIST E1"); copyMultHistMC2->SetLineWidth(2); copyMultHistMC2->SetLineColor(kGreen); copyMultHistMC2->GetYaxis()->SetRangeUser(0, 5);
  copyMultHistMC3->Draw("SAME HIST E1"); copyMultHistMC3->SetLineWidth(2); copyMultHistMC3->SetLineColor(kBlue); copyMultHistMC3->GetYaxis()->SetRangeUser(0, 5); copyMultHistMC3->SetStats(0);
  copyMultHistMC4->Draw("SAME HIST E1"); copyMultHistMC4->SetLineWidth(2); copyMultHistMC4->SetLineColor(kMagenta); copyMultHistMC4->GetYaxis()->SetRangeUser(0, 5); copyMultHistMC4->SetStats(0);
  copyMultHistMC5->Draw("SAME HIST E1"); copyMultHistMC5->SetLineWidth(2); copyMultHistMC5->SetLineColor(kOrange + 2); copyMultHistMC5->GetYaxis()->SetRangeUser(0, 5); copyMultHistMC5->SetStats(0);
  copyMultHistMC1->Draw("SAME HIST E1"); copyMultHistMC1->SetLineWidth(2); copyMultHistMC1->SetLineColor(kRed); copyMultHistMC1->GetYaxis()->SetRangeUser(0, 5); copyMultHistMC1->SetStats(0);
...
void HistDraw(TH1F *hist1, TH1F *hist2, TH1F *hist3, TH1F *hist4, TH1F *hist5, TH1F *hist6)
{
  ...
  */
  ...
  hist2->SetStats(0);
  hist2->Draw("SAMES HIST"); hist2->SetLineColor(kGreen); hist2->SetLineStyle(1); hist2->SetLineWidth(2); //hist2->SetFillColorAlpha(kRed, 0.2);
  /*
  Canvas->Update();
