...
void DataMCComp4()
{
  ...
  */
  ...
  copyMultHistMC2->Draw("HIST E1"); copyMultHistMC2->SetLineWidth(2); copyMultHistMC2->SetLineColor(kGreen); copyMultHistMC2->GetYaxis()->SetRangeUser(0, 5.1);
  copyMultHistMC3->Draw("SAME HIST E1"); copyMultHistMC3->SetLineWidth(2); copyMultHistMC3->SetLineColor(kBlue); copyMultHistMC3->GetYaxis()->SetRangeUser(0, 5.1); copyMultHistMC3->SetStats(0);
  copyMultHistMC4->Draw("SAME HIST E1"); copyMultHistMC4->SetLineWidth(2); copyMultHistMC4->SetLineColor(kMagenta); copyMultHistMC4->GetYaxis()->SetRangeUser(0, 5.1); copyMultHistMC4->SetStats(0);
  copyMultHistMC5->Draw("SAME HIST E1"); copyMultHistMC5->SetLineWidth(2); copyMultHistMC5->SetLineColor(kOrange + 2); copyMultHistMC5->GetYaxis()->SetRangeUser(0, 5.1); copyMultHistMC5->SetStats(0);
  copyMultHistMC1->Draw("SAME HIST E1"); copyMultHistMC1->SetLineWidth(2); copyMultHistMC1->SetLineColor(kRed); copyMultHistMC1->GetYaxis()->SetRangeUser(0, 5.1); copyMultHistMC1->SetStats(0);
