...
void DataMCComp3()
{
  ...
  {
    char data1Name [256], data2Name[256];

    sprintf(data1Name, "../../../Data_v20220912/PD05/Linked/RootOut/p%02d6.root", dirIndex);

    if (dirIndex < 7) { sprintf(data2Name, "../../../EPOSSM_v2.1/Linked/RootOut/pl%02d1_%02d0.root", dirIndex, dirIndex + 3); }
    else { sprintf(data2Name, "../../../EPOSSM_v2.1/Linked/RootOut/pl071_105.root"); }

    Data1 = TFile::Open(data1Name);
    Data2 = TFile::Open(data2Name);
  ...
  gPad->SetGrid(100);
  //IPData1->Draw();
  SlpT2Hist1->GetYaxis()->SetRangeUser(0, 120000);
  ...
  Canvas->cd(1);
  //IPData1->Draw();
  Mult1->GetYaxis()->SetRangeUser(0, 3500);
