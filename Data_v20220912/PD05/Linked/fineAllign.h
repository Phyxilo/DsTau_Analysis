       ...
       for(int x=1;x<=63;x++)
        {
            ...
            for (int i=pl1; i<=pl1+11;i++) //i nu e 1 si N e dat de file 
            {
                ...
                sprintf(filename, "ParFineAlign/PR2018_PD05/pl%03d_%03d/reco%02d_%06d_%06d/par_finealign/%02d_001.par",pl1,pl2,x,currentRow,currentColumn,i);
            ...
            sprintf(outfilenamep,"ParFineAlign/limits_PD05/limits_subarea_%0d_PD05_subvolume_%d_%d_Plastic.txt",x, pl1, pl2);
            ...
            sprintf(outfilenamet,"ParFineAlign/limits_PD05/limits_subarea_%0d_PD05_subvolume_%d_%d_Tungsten.txt",x, pl1, pl2);
            ...
            sprintf(outfilenamee,"ParFineAlign/limits_PD05/limits_subarea_%0d_PD05_subvolume_%d_%d_Emulsion.txt",x, pl1, pl2);
...
void limits(int subarea, int plt)
{
    ...
    ifstream fp;
    char Plastic[500];  
    sprintf(Plastic,"ParFineAlign/limits_PD05/limits_subarea_%0d_PD05_subvolume_%d_%d_Plastic.txt",subarea,plt,pl2);
    fp.open (Plastic);
    ...
    ifstream fe;
    char Emulsion[500];
    sprintf(Emulsion,"ParFineAlign/limits_PD05/limits_subarea_%0d_PD05_subvolume_%d_%d_Emulsion.txt",subarea,plt,pl2);
    fe.open (Emulsion);
    ...
    ifstream ft;
    char Tungsten[500];
    sprintf(Tungsten,"ParFineAlign/limits_PD05/limits_subarea_%0d_PD05_subvolume_%d_%d_Tungsten.txt",subarea,plt,pl2);
    ft.open (Tungsten); 
